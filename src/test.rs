...
async fn test_weather_data_ok() {
    ...
    let payload = r#"[{"measurement_time_default":"2021-03-24T20:50:00+00:00","id":228,"index":201,"field_description":"relative_humidity","measurement":77.5}]"#;
...
async fn test_weather_stations_ok() {
    ...
    let payload = r#"[{"publication_time":"2021-03-05T11:22:01.628+00:00","id":205,"name":"E6 Rosten","latitude":61.878395,"longitude":9.41545}]"#;
