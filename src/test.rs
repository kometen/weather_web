...
async fn test_weather_stations_ok() {
    ...
    let payload = r#"[{"publication_time":"2021-03-05T11:22:01.628+01:00","id":205,"name":"E6 Rosten","latitude":61.878395,"longitude":9.41545}]"#.as_bytes();
